...
public class MessageService {
    ...
    public void sendFirstMessageToOfferer(long receiverId, String senderLoginId, long articleId,
        ...
        Message myMessage = messageConverter.createMessage(sender, receiver, content,
            myMessageRoom);
        Message offererMessage = messageConverter.createMessage(sender, receiver, content,
            offererMessageRoom);
